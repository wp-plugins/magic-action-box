...
body .<?php echo $class; ?>, body div.magic-action-box .<?php echo $class; ?>, body div.magic-action-box .mab-content .<?php echo $class; ?>{
	display: inline-block;
	text-decoration: none !important;

	<?php ### BACKGROUND ?>
	<span class="property">background</span>: <span class="c background-color-start"><?php echo $button['background-color-start']; ?></span>;
	...
	<span class="property">background</span>: <span class="property">-moz-linear-gradient</span>( top,
		...
		<span class="c background-color-end"><?php echo $button['background-color-end']; ?></span> 100% );
	...
	<span class="property">background</span>: <span class="property">-webkit-gradient</span>( 
		...
		to(<span class="c background-color-end"><?php echo $button['background-color-end']; ?></span>) );
	...
	<span class="property">background</span>: <span class="property">-ms-linear-gradient</span>( top,
		...
		<span class="c background-color-end"><?php echo $button['background-color-end']; ?></span> 100% );
	<?php //W3C ?>
	<span class="property">background</span>: <span class="property">linear-gradient</span>( top,
		<span class="c background-color-start"><?php echo $button['background-color-start']; ?></span> 0%,
		<span class="c background-color-end"><?php echo $button['background-color-end']; ?></span> 100% );
	<?php endif; ?>
	...
	<span class="property">-moz-box-shadow</span>: 
		...
		inset <span class="s inset-shadow-x"><?php echo $button['inset-shadow-x']; ?></span>px <span class="s inset-shadow-y"><?php echo $button['inset-shadow-y']; ?></span>px <span class="s inset-shadow-size"><?php echo $button['inset-shadow-size']; ?></span>px rgba( <span class="rgb inset-shadow-color"><?php echo $MabBase->RGB2hex($button['inset-shadow-color']); ?></span>, <span class="a inset-shadow-opacity"><?php echo $button['inset-shadow-opacity']; ?></span>);
	...
	<span class="property">text-shadow</span>: 
		<span class="s text-shadow-1-x"><?php echo $button['text-shadow-1-x']; ?></span>px <span class="s text-shadow-1-y"><?php echo $button['text-shadow-1-y']; ?></span>px <span class="s text-shadow-1-size"><?php echo $button['text-shadow-1-size']; ?></span>px rgb(<span class="rgb text-shadow-1-color"><?php echo $MabBase->RGB2hex($button['text-shadow-1-color']); ?></span>);
...
body .<?php echo $class; ?>:hover, body div.magic-action-box .<?php echo $class; ?>:hover, body div.magic-action-box .mab-content .<?php echo $class; ?>:hover{
	text-decoration: none !important;
	...
	<span class="property">background</span>: <span class="property">-moz-linear-gradient</span>( top,
		...
		<span class="c background-color-hover-end"><?php echo $button['background-color-hover-end']; ?></span> 100% );
	<?php //Webkit Chrome, Safari4+ ?>
	<span class="property">background</span>: <span class="property">-webkit-gradient</span>( 
		linear, left top, left bottom,
		from(<span class="c background-color-hover-start"><?php echo $button['background-color-hover-start']; ?></span>),
		to(<span class="c background-color-hover-end"><?php echo $button['background-color-hover-end']; ?></span>) );
	<?php //Webkit Chrosm10+, Safari5.1+ ?>
	<span class="property">background</span>: <span class="property">-webkit-linear-gradient</span>( top,
		<span class="c background-color-hover-start"><?php echo $button['background-color-hover-start']; ?></span> 0%,
		<span class="c background-color-hover-end"><?php echo $button['background-color-hover-end']; ?></span> 100% );
...
body .<?php echo $class; ?>:focus, body div.magic-action-box .<?php echo $class; ?>:focus, body div.magic-action-box .mab-content .<?php echo $class; ?>:focus{
	<span class="property">color</span>: <span class="c font-color"><?php echo $button['font-color']; ?></span> !important;
}
